		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="box box-success box-solid">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
											<form class="form-horizontal" role="form" method="POST" action="{{route('images.update',$image)}}" enctype="multipart/form-data">
												{{ csrf_field() }}

												{{-- permet d'utiliser le type put --}}
    										<input type="hidden" name="_method" value="put">
												...
												<div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
														...
														<div class="col-md-6">
																<input id="content" type="textarea" class="form-control" name="content" value="{{$image->content}}"  >
														...
														<div class="form-group">
															<div class="col-md-6 col-md-offset-4">
																<img src="/img/imageDB/{{$image->user_id}}/{{$image->picture}}" alt="{{$image->content}}" style="padding-top:10px;" class="img-rounded img-responsive center-block">
															</div>
														</div>

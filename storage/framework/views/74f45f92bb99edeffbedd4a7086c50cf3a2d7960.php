...
<head>
    ...
    <meta name="description" content="Image Storage - <?php echo e(trans('adminlte_lang::message.landingdescription')); ?> ">
    <meta name="author" content="Jules Ragot">

    <meta property="og:title" content="ImgStorage" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="Image Storage - Base de photos" />
    ...
    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>Image Storage</b></a>
            </div>
        ...
        <div id="headerwrap">
            <div class="container">
                <div class="row centered">
                    <div class="col-lg-12">
                        <h1>Jules <b><a href="">Image Storage</a></b></h1>
                        <h3>Un site permettant de stocker ses photos ainsi que de partager ses plus belle prise de vue avec la communauté</h3>
                    </div>
                    <div class="col-lg-2">
                        <h5>Un menu intuitif</h5>
                        <p>Permettant une navigation aisée</p>
